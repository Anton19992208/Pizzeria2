...
public class ValidateOrderAction implements Action<PizzaOrderStatus, PizzaOrderEvent> {
    ...
    public void execute(StateContext<PizzaOrderStatus, PizzaOrderEvent> stateContext) {
        ...
        log.debug("Sent Validation request to queue for order id " + pizzaOrderId);
    }
}
